...
export const metadata: Metadata = {
    title: 'Medallas y Monedas de Metal | Crea Imagen',
    description: 'Símbolos de honor en metal fundido y acabado premium.',
};

export default function MedallasYMonedasPage() {
    const directoryPath = path.join(process.cwd(), 'public/images/medallas-y-monedas');
    let images: string[] = [];
    ...
    try {
        ...
        images = files
            ...
            .map((file) => `/images/medallas-y-monedas/${file}`);
    } catch (error) {
