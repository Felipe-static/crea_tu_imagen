      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
             ...
             <h2 className="text-3xl font-light leading-relaxed md:text-5xl lg:leading-tight font-serif text-slate-900">
              "Un reconocimiento no es solo un objeto sobre un escritorio. Es el momento exacto en que una organización dice: <span className="italic text-amber-600 font-medium font-serif bg-amber-50/50 px-2 rounded">'Te vemos, te valoramos y te agradecemos'</span>."
            </h2>
