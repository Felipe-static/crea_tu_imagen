  ...
  return (
    ...
    >
      ...
      <div className="space-y-1 px-1">
        <div className="text-xs italic text-amber-700 tracking-wider uppercase">{product.category}</div>
        <h3 className="font-bold text-lg text-stone-900 mb-1 line-clamp-1 group-hover:text-amber-700 transition-colors">{product.name}</h3>
      </div>
    </motion.div>
  );
}
